...
-- Giữ lại: admin profile, thông tin cửa hàng (stores), file backup trên Storage.
-- Ảnh repair-photos xóa từ Dart qua Storage API (không xóa trực tiếp storage.objects).
...
begin
  ...
  -- Xóa con trước cha (FK dependencies)
